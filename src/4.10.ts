...
Для разрешения коллизий используйте метод цепочек с массивом, 
как вложенной структурой данных. Пару ключ-значение храните также в массиве [key, value]. 
Для хеширования примените функцию hash

---

- Передайте функции hash ключ и размер массива.
- this.memory выглядит как двумерный массив. 
  Проверяйте наличие вложенного массива прежде, чем добавлять в него значения.
